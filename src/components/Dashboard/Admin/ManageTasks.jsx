              ...
              {items?.map((task, index) => (
                <tr key={task._id}>
                  ...
                  <td>
                    ...
                    >
                      <button
                        className="absolute top-0 right-0 bg-blue-100 p-2 text-sm font-medium rounded-full text-blue-900 hover:text-blue-700 hover:bg-blue-500 focus:outline-none"
                        onClick={closeModal}
                      >
                        <MdClose />
                      </button>
